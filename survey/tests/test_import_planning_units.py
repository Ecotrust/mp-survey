...
class ImportPlanningUnitsTest(TestCase):
    ...
    def setUp(self):
        ...
        self.test_file_path = os.path.join(
            os.path.dirname(__file__), 'data', 'geojson', 'test_grid.geojson'
        )
    ...
    def test_error_shapefile_missing_prj(self):
        ...
        shapefile_path = os.path.join(
            os.path.dirname(__file__), 'data', 'shp', 'missing_prj', 'test_grid.shp'
        )
    ...
    def test_successful_shapefile_import(self):
        ...
        shapefile_path = os.path.join(
            os.path.dirname(__file__), 'data', 'shp', 'complete', 'test_grid.shp'
        )
    ...
    def test_successful_zip_import(self):
        ...
        zip_path = os.path.join(
            os.path.dirname(__file__), 'data', 'shp', 'zipped', 'test_grid.zip'
        )
    ...
    def test_transaction_rollback_on_error(self):
        ...
        invalid_file_path = os.path.join(
            os.path.dirname(__file__), 'data', 'invalid_test.geojson'
        )
